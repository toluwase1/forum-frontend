          ...
          <CardBody>
            <form onSubmit={submitUser}>
              <FormGroup>
                ...
                />
                {currentState.PostsState.postsError &&
                currentState.PostsState.postsError.Required_title ? (
                ...
                {currentState.PostsState.postsError &&
                currentState.PostsState.postsError.Taken_title ? (
                  <small className="color-red">
                    {currentState.PostsState.postsError.Taken_title}
                  </small>
                ) : (
              ...
              <FormGroup>
                ...
                />
                {currentState.PostsState.postsError &&
                currentState.PostsState.postsError.Required_content ? (
                  <small className="color-red">
                    {currentState.PostsState.postsError.Required_content}
                  </small>
                ) : (
