...
const EditComment = ({ comment, className }) => {
  ...
  const theUpdate = (details) =>
    dispatch(updateComment(details, updateSuccess));
        ...
        <ModalBody>
          <FormGroup>
            ...
            <textarea
              ...
              defaultValue={commentUpdate.body}
              onChange={handleChange}
            ></textarea>
            {currentState.CommentsState.commentsError &&
            currentState.CommentsState.commentsError.Required_body ? (
